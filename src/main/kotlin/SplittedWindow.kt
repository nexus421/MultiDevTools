...
fun SplittedWindow(
    ...
    Column {
        topView?.let {
            Box(
                modifier = Modifier.padding(bottom = 4.dp).border(2.dp, Color.Gray, shape)
                    .padding(8.dp).fillMaxWidth(), content = it
            )
        }
        Row(Modifier.weight(1f)) {
            Box(
                modifier = Modifier.weight(1f).border(2.dp, Color.Gray, shape).padding(8.dp)
                    .fillMaxHeight(),
                content = leftSide
            )
            ...
            middle?.let {
                Column(
                    modifier = Modifier.weight(0.5f).border(2.dp, Color.Gray, shape).padding(8.dp)
                        .fillMaxHeight(),
                    content = it
                )
                Spacer(Modifier.width(4.dp))
